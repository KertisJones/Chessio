...
{
    private static readonly Dictionary<uint, List<Improbable.Persistence.Update>> Storage = new Dictionary<uint, List<Improbable.Persistence.Update>>();
    ...
    public static uint Allocate(global::Unity.Entities.World world)
    {
        ...
        Storage.Add(handle, default(List<Improbable.Persistence.Update>));
        WorldMapping.Add(handle, world);

        return handle;
    }

    public static List<Improbable.Persistence.Update> Get(uint handle)
    {
    ...
    public static void Set(uint handle, List<Improbable.Persistence.Update> value)
    {
