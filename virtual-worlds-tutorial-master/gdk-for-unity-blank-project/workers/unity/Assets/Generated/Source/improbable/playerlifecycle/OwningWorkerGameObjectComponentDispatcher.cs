...
namespace Improbable.PlayerLifecycle
{
    public partial class OwningWorker
    {
        internal class GameObjectComponentDispatcher : GameObjectComponentDispatcherBase
        {
            ...
            {
                ComponentType.ReadOnly<ComponentAdded<Improbable.PlayerLifecycle.OwningWorker.Component>>(), ComponentType.ReadOnly<GameObjectReference>()
            };

            public override ComponentType[] ComponentRemovedComponentTypes => new ComponentType[]
            {
                ComponentType.ReadOnly<ComponentRemoved<Improbable.PlayerLifecycle.OwningWorker.Component>>(), ComponentType.ReadOnly<GameObjectReference>()
            };

            public override ComponentType[] AuthorityGainedComponentTypes => new ComponentType[]
            {
                ComponentType.ReadOnly<AuthorityChanges<Improbable.PlayerLifecycle.OwningWorker.Component>>(), ComponentType.ReadOnly<GameObjectReference>(),
            ...
            {
                ComponentType.ReadOnly<AuthorityChanges<Improbable.PlayerLifecycle.OwningWorker.Component>>(), ComponentType.ReadOnly<GameObjectReference>(),
                ComponentType.ReadOnly<NotAuthoritative<Improbable.PlayerLifecycle.OwningWorker.Component>>()
            };
            ...
            {
                ComponentType.ReadOnly<Improbable.PlayerLifecycle.OwningWorker.ReceivedUpdates>(), ComponentType.ReadOnly<GameObjectReference>()
            };
            ...
            private const uint componentId = 13003;
            ...
            public override void MarkAuthorityGainedForActivation(Dictionary<Unity.Entities.Entity, MonoBehaviourActivationManager> entityToManagers)
            {
                ...
                Profiler.BeginSample("OwningWorker");
                var authoritiesChangedTags = AuthorityGainedComponentGroup.GetComponentDataArray<AuthorityChanges<Improbable.PlayerLifecycle.OwningWorker.Component>>();
            ...
            public override void MarkAuthorityLostForDeactivation(Dictionary<Unity.Entities.Entity, MonoBehaviourActivationManager> entityToManagers)
            {
                ...
                Profiler.BeginSample("OwningWorker");
                var authoritiesChangedTags = AuthorityLostComponentGroup.GetComponentDataArray<AuthorityChanges<Improbable.PlayerLifecycle.OwningWorker.Component>>();
            ...
            public override void InvokeOnComponentUpdateCallbacks(Dictionary<Unity.Entities.Entity, InjectableStore> entityToInjectableStore)
            {
                ...
                var updateLists = ComponentsUpdatedComponentGroup.GetComponentDataArray<Improbable.PlayerLifecycle.OwningWorker.ReceivedUpdates>();
                for (var i = 0; i < entities.Length; i++)
                {
            ...
            public override void InvokeOnAuthorityGainedCallbacks(Dictionary<Unity.Entities.Entity, InjectableStore> entityToInjectableStore)
            {
                ...
                Profiler.BeginSample("OwningWorker");
                var entities = AuthorityGainedComponentGroup.GetEntityArray();
                var changeOpsLists = AuthorityGainedComponentGroup.GetComponentDataArray<AuthorityChanges<Improbable.PlayerLifecycle.OwningWorker.Component>>();
            ...
            public override void InvokeOnAuthorityLostCallbacks(Dictionary<Unity.Entities.Entity, InjectableStore> entityToInjectableStore)
            {
                ...
                Profiler.BeginSample("OwningWorker");
                var entities = AuthorityLostComponentGroup.GetEntityArray();
                var changeOpsLists = AuthorityLostComponentGroup.GetComponentDataArray<AuthorityChanges<Improbable.PlayerLifecycle.OwningWorker.Component>>();
            ...
            private bool IsFirstAuthChange(Authority authToMatch, AuthorityChanges<Improbable.PlayerLifecycle.OwningWorker.Component> changeOps)
            {
