...
{
    private static readonly Dictionary<uint, List<Improbable.PlayerLifecycle.PlayerHeartbeatServer.Update>> Storage = new Dictionary<uint, List<Improbable.PlayerLifecycle.PlayerHeartbeatServer.Update>>();
    ...
    public static uint Allocate(global::Unity.Entities.World world)
    {
        ...
        Storage.Add(handle, default(List<Improbable.PlayerLifecycle.PlayerHeartbeatServer.Update>));
        WorldMapping.Add(handle, world);

        return handle;
    }

    public static List<Improbable.PlayerLifecycle.PlayerHeartbeatServer.Update> Get(uint handle)
    {
    ...
    public static void Set(uint handle, List<Improbable.PlayerLifecycle.PlayerHeartbeatServer.Update> value)
    {
