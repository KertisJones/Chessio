...
namespace Improbable
{
    public partial class Interest
    {
        internal class GameObjectComponentDispatcher : GameObjectComponentDispatcherBase
        {
            ...
            {
                ComponentType.ReadOnly<ComponentAdded<Improbable.Interest.Component>>(), ComponentType.ReadOnly<GameObjectReference>()
            };

            public override ComponentType[] ComponentRemovedComponentTypes => new ComponentType[]
            {
                ComponentType.ReadOnly<ComponentRemoved<Improbable.Interest.Component>>(), ComponentType.ReadOnly<GameObjectReference>()
            };

            public override ComponentType[] AuthorityGainedComponentTypes => new ComponentType[]
            {
                ComponentType.ReadOnly<AuthorityChanges<Improbable.Interest.Component>>(), ComponentType.ReadOnly<GameObjectReference>(),
            ...
            {
                ComponentType.ReadOnly<AuthorityChanges<Improbable.Interest.Component>>(), ComponentType.ReadOnly<GameObjectReference>(),
                ComponentType.ReadOnly<NotAuthoritative<Improbable.Interest.Component>>()
            };
            ...
            {
                ComponentType.ReadOnly<Improbable.Interest.ReceivedUpdates>(), ComponentType.ReadOnly<GameObjectReference>()
            };
            ...
            private const uint componentId = 58;
            ...
            public override void MarkAuthorityGainedForActivation(Dictionary<Unity.Entities.Entity, MonoBehaviourActivationManager> entityToManagers)
            {
                ...
                Profiler.BeginSample("Interest");
                var authoritiesChangedTags = AuthorityGainedComponentGroup.GetComponentDataArray<AuthorityChanges<Improbable.Interest.Component>>();
            ...
            public override void MarkAuthorityLostForDeactivation(Dictionary<Unity.Entities.Entity, MonoBehaviourActivationManager> entityToManagers)
            {
                ...
                Profiler.BeginSample("Interest");
                var authoritiesChangedTags = AuthorityLostComponentGroup.GetComponentDataArray<AuthorityChanges<Improbable.Interest.Component>>();
            ...
            public override void InvokeOnComponentUpdateCallbacks(Dictionary<Unity.Entities.Entity, InjectableStore> entityToInjectableStore)
            {
                ...
                var updateLists = ComponentsUpdatedComponentGroup.GetComponentDataArray<Improbable.Interest.ReceivedUpdates>();
                for (var i = 0; i < entities.Length; i++)
                {
            ...
            public override void InvokeOnAuthorityGainedCallbacks(Dictionary<Unity.Entities.Entity, InjectableStore> entityToInjectableStore)
            {
                ...
                Profiler.BeginSample("Interest");
                var entities = AuthorityGainedComponentGroup.GetEntityArray();
                var changeOpsLists = AuthorityGainedComponentGroup.GetComponentDataArray<AuthorityChanges<Improbable.Interest.Component>>();
            ...
            public override void InvokeOnAuthorityLostCallbacks(Dictionary<Unity.Entities.Entity, InjectableStore> entityToInjectableStore)
            {
                ...
                Profiler.BeginSample("Interest");
                var entities = AuthorityLostComponentGroup.GetEntityArray();
                var changeOpsLists = AuthorityLostComponentGroup.GetComponentDataArray<AuthorityChanges<Improbable.Interest.Component>>();
            ...
            private bool IsFirstAuthChange(Authority authToMatch, AuthorityChanges<Improbable.Interest.Component> changeOps)
            {
