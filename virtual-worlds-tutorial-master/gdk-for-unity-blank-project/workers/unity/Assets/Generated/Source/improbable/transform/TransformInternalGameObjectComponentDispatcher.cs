...
namespace Improbable.Transform
{
    public partial class TransformInternal
    {
        internal class GameObjectComponentDispatcher : GameObjectComponentDispatcherBase
        {
            ...
            {
                ComponentType.ReadOnly<ComponentAdded<Improbable.Transform.TransformInternal.Component>>(), ComponentType.ReadOnly<GameObjectReference>()
            };

            public override ComponentType[] ComponentRemovedComponentTypes => new ComponentType[]
            {
                ComponentType.ReadOnly<ComponentRemoved<Improbable.Transform.TransformInternal.Component>>(), ComponentType.ReadOnly<GameObjectReference>()
            };

            public override ComponentType[] AuthorityGainedComponentTypes => new ComponentType[]
            {
                ComponentType.ReadOnly<AuthorityChanges<Improbable.Transform.TransformInternal.Component>>(), ComponentType.ReadOnly<GameObjectReference>(),
            ...
            {
                ComponentType.ReadOnly<AuthorityChanges<Improbable.Transform.TransformInternal.Component>>(), ComponentType.ReadOnly<GameObjectReference>(),
                ComponentType.ReadOnly<NotAuthoritative<Improbable.Transform.TransformInternal.Component>>()
            };
            ...
            {
                ComponentType.ReadOnly<Improbable.Transform.TransformInternal.ReceivedUpdates>(), ComponentType.ReadOnly<GameObjectReference>()
            };
            ...
            private const uint componentId = 11000;
            ...
            public override void MarkAuthorityGainedForActivation(Dictionary<Unity.Entities.Entity, MonoBehaviourActivationManager> entityToManagers)
            {
                ...
                Profiler.BeginSample("TransformInternal");
                var authoritiesChangedTags = AuthorityGainedComponentGroup.GetComponentDataArray<AuthorityChanges<Improbable.Transform.TransformInternal.Component>>();
            ...
            public override void MarkAuthorityLostForDeactivation(Dictionary<Unity.Entities.Entity, MonoBehaviourActivationManager> entityToManagers)
            {
                ...
                Profiler.BeginSample("TransformInternal");
                var authoritiesChangedTags = AuthorityLostComponentGroup.GetComponentDataArray<AuthorityChanges<Improbable.Transform.TransformInternal.Component>>();
            ...
            public override void InvokeOnComponentUpdateCallbacks(Dictionary<Unity.Entities.Entity, InjectableStore> entityToInjectableStore)
            {
                ...
                var updateLists = ComponentsUpdatedComponentGroup.GetComponentDataArray<Improbable.Transform.TransformInternal.ReceivedUpdates>();
                for (var i = 0; i < entities.Length; i++)
                {
            ...
            public override void InvokeOnAuthorityGainedCallbacks(Dictionary<Unity.Entities.Entity, InjectableStore> entityToInjectableStore)
            {
                ...
                Profiler.BeginSample("TransformInternal");
                var entities = AuthorityGainedComponentGroup.GetEntityArray();
                var changeOpsLists = AuthorityGainedComponentGroup.GetComponentDataArray<AuthorityChanges<Improbable.Transform.TransformInternal.Component>>();
            ...
            public override void InvokeOnAuthorityLostCallbacks(Dictionary<Unity.Entities.Entity, InjectableStore> entityToInjectableStore)
            {
                ...
                Profiler.BeginSample("TransformInternal");
                var entities = AuthorityLostComponentGroup.GetEntityArray();
                var changeOpsLists = AuthorityLostComponentGroup.GetComponentDataArray<AuthorityChanges<Improbable.Transform.TransformInternal.Component>>();
            ...
            private bool IsFirstAuthChange(Authority authToMatch, AuthorityChanges<Improbable.Transform.TransformInternal.Component> changeOps)
            {
