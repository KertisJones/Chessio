    ...
    public partial class Persistence
    {
        ...
        public struct Component : IComponentData, ISpatialComponentData, ISnapshottable<Snapshot>
        {
            ...
            */
            ...
            {
                var componentDataSchema = new ComponentData(new SchemaComponentData(55));
        ...
        public static class Serialization
        {
            ...
            public static void SerializeSnapshot(Improbable.Persistence.Snapshot snapshot, global::Improbable.Worker.CInterop.SchemaObject obj)
            {
            }
            ...
            public static Improbable.Persistence.Update DeserializeUpdate(global::Improbable.Worker.CInterop.SchemaComponentUpdate updateObj)
            {
            ...
            public static Improbable.Persistence.Snapshot DeserializeSnapshot(global::Improbable.Worker.CInterop.SchemaObject obj, global::Unity.Entities.World world)
            {
                var component = new Improbable.Persistence.Snapshot();
        ...
        public struct ReceivedUpdates : IComponentData
        {
            ...
            {
                get => Improbable.Persistence.ReferenceTypeProviders.UpdatesProvider.Get(handle);
            }
        }

        internal class PersistenceDynamic : IDynamicInvokable
        {
            public uint ComponentId => Persistence.ComponentId;
            ...
            {
                handler.Accept<Component, Update>(Persistence.ComponentId, DeserializeData, DeserializeUpdate);
            }

            public void InvokeSnapshotHandler(DynamicSnapshot.ISnapshotHandler handler)
            {
                handler.Accept<Snapshot>(Persistence.ComponentId, DeserializeSnapshot, SerializeSnapshot);
            }
        }
    }
}
