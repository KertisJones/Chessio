...
{
    private static readonly Dictionary<uint, List<Improbable.EntityAcl.Update>> Storage = new Dictionary<uint, List<Improbable.EntityAcl.Update>>();
    ...
    public static uint Allocate(global::Unity.Entities.World world)
    {
        ...
        Storage.Add(handle, default(List<Improbable.EntityAcl.Update>));
        WorldMapping.Add(handle, world);

        return handle;
    }

    public static List<Improbable.EntityAcl.Update> Get(uint handle)
    {
    ...
    public static void Set(uint handle, List<Improbable.EntityAcl.Update> value)
    {
