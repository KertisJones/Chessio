    ...
    public partial class PlayerCreator
    {
        ...
        public struct Component : IComponentData, ISpatialComponentData, ISnapshottable<Snapshot>
        {
            ...
            */
            ...
            {
                var componentDataSchema = new ComponentData(new SchemaComponentData(13000));
        ...
        public static class Serialization
        {
            ...
            public static void SerializeSnapshot(Improbable.PlayerLifecycle.PlayerCreator.Snapshot snapshot, global::Improbable.Worker.CInterop.SchemaObject obj)
            {
            }
            ...
            public static Improbable.PlayerLifecycle.PlayerCreator.Update DeserializeUpdate(global::Improbable.Worker.CInterop.SchemaComponentUpdate updateObj)
            {
            ...
            public static Improbable.PlayerLifecycle.PlayerCreator.Snapshot DeserializeSnapshot(global::Improbable.Worker.CInterop.SchemaObject obj, global::Unity.Entities.World world)
            {
                var component = new Improbable.PlayerLifecycle.PlayerCreator.Snapshot();
        ...
        public struct ReceivedUpdates : IComponentData
        {
            ...
            {
                get => Improbable.PlayerLifecycle.PlayerCreator.ReferenceTypeProviders.UpdatesProvider.Get(handle);
            }
        }
        ...
        internal class PlayerCreatorDynamic : IDynamicInvokable
        {
            ...
            {
                handler.Accept<Component, Update>(PlayerCreator.ComponentId, DeserializeData, DeserializeUpdate);
            }

            public void InvokeSnapshotHandler(DynamicSnapshot.ISnapshotHandler handler)
            {
                handler.Accept<Snapshot>(PlayerCreator.ComponentId, DeserializeSnapshot, SerializeSnapshot);
            }
        }
    }
}
