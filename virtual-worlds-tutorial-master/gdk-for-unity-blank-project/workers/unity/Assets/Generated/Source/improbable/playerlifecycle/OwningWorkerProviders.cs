...
{
    private static readonly Dictionary<uint, List<Improbable.PlayerLifecycle.OwningWorker.Update>> Storage = new Dictionary<uint, List<Improbable.PlayerLifecycle.OwningWorker.Update>>();
    ...
    public static uint Allocate(global::Unity.Entities.World world)
    {
        ...
        Storage.Add(handle, default(List<Improbable.PlayerLifecycle.OwningWorker.Update>));
        WorldMapping.Add(handle, world);

        return handle;
    }

    public static List<Improbable.PlayerLifecycle.OwningWorker.Update> Get(uint handle)
    {
    ...
    public static void Set(uint handle, List<Improbable.PlayerLifecycle.OwningWorker.Update> value)
    {
