...
namespace Improbable.PlayerLifecycle
{
    public partial class PlayerCreator
    {
        internal class GameObjectComponentDispatcher : GameObjectComponentDispatcherBase
        {
            ...
            {
                ComponentType.ReadOnly<ComponentAdded<Improbable.PlayerLifecycle.PlayerCreator.Component>>(), ComponentType.ReadOnly<GameObjectReference>()
            };

            public override ComponentType[] ComponentRemovedComponentTypes => new ComponentType[]
            {
                ComponentType.ReadOnly<ComponentRemoved<Improbable.PlayerLifecycle.PlayerCreator.Component>>(), ComponentType.ReadOnly<GameObjectReference>()
            };

            public override ComponentType[] AuthorityGainedComponentTypes => new ComponentType[]
            {
                ComponentType.ReadOnly<AuthorityChanges<Improbable.PlayerLifecycle.PlayerCreator.Component>>(), ComponentType.ReadOnly<GameObjectReference>(),
            ...
            {
                ComponentType.ReadOnly<AuthorityChanges<Improbable.PlayerLifecycle.PlayerCreator.Component>>(), ComponentType.ReadOnly<GameObjectReference>(),
                ComponentType.ReadOnly<NotAuthoritative<Improbable.PlayerLifecycle.PlayerCreator.Component>>()
            };
            ...
            {
                new ComponentType[] { ComponentType.ReadOnly<CommandRequests.CreatePlayer>(), ComponentType.ReadOnly<GameObjectReference>() },
            };

            public override ComponentType[][] CommandResponsesComponentTypeArrays => new ComponentType[][]
            {
                new ComponentType[] { ComponentType.ReadOnly<CommandResponses.CreatePlayer>(), ComponentType.ReadOnly<GameObjectReference>() },
            };

            private const uint componentId = 13000;
            ...
            public override void MarkAuthorityGainedForActivation(Dictionary<Unity.Entities.Entity, MonoBehaviourActivationManager> entityToManagers)
            {
                ...
                Profiler.BeginSample("PlayerCreator");
                var authoritiesChangedTags = AuthorityGainedComponentGroup.GetComponentDataArray<AuthorityChanges<Improbable.PlayerLifecycle.PlayerCreator.Component>>();
            ...
            public override void MarkAuthorityLostForDeactivation(Dictionary<Unity.Entities.Entity, MonoBehaviourActivationManager> entityToManagers)
            {
                ...
                Profiler.BeginSample("PlayerCreator");
                var authoritiesChangedTags = AuthorityLostComponentGroup.GetComponentDataArray<AuthorityChanges<Improbable.PlayerLifecycle.PlayerCreator.Component>>();
            ...
            public override void InvokeOnCommandRequestCallbacks(Dictionary<Unity.Entities.Entity, InjectableStore> entityToInjectableStore)
            {
                ...
                if (!CommandRequestsComponentGroups[0].IsEmptyIgnoreFilter)
                {
                    ...
                    var commandRequestLists = CommandRequestsComponentGroups[0].GetComponentDataArray<CommandRequests.CreatePlayer>();
                    for (var i = 0; i < entities.Length; i++)
                    {
                        ...
                        foreach (Requirable.CommandRequestHandler commandRequestHandler in commandRequestHandlers)
                        {
                            ...
                            {
                                commandRequestHandler.OnCreatePlayerRequestInternal(commandRequest);
                            }
                        }
                    }
                }
            ...
            public override void InvokeOnCommandResponseCallbacks(Dictionary<Unity.Entities.Entity, InjectableStore> entityToInjectableStore)
            {
                ...
                if (!CommandResponsesComponentGroups[0].IsEmptyIgnoreFilter)
                {
                    ...
                    var commandResponseLists = CommandResponsesComponentGroups[0].GetComponentDataArray<CommandResponses.CreatePlayer>();
                    for (var i = 0; i < entities.Length; i++)
                    {
                        var injectableStore = entityToInjectableStore[entities[i]];
                        ...
                        foreach (var commandResponse in commandResponseList.Responses)
                        {
                            if (commandResponseHandlers != null)
                            {
                                ...
                                {
                                    commandResponseHandler.OnCreatePlayerResponseInternal(commandResponse);
                                }
                            }

                            var callback = commandResponse.Context as Action<CreatePlayer.ReceivedResponse>;
            ...
            public override void InvokeOnAuthorityGainedCallbacks(Dictionary<Unity.Entities.Entity, InjectableStore> entityToInjectableStore)
            {
                ...
                Profiler.BeginSample("PlayerCreator");
                var entities = AuthorityGainedComponentGroup.GetEntityArray();
                var changeOpsLists = AuthorityGainedComponentGroup.GetComponentDataArray<AuthorityChanges<Improbable.PlayerLifecycle.PlayerCreator.Component>>();
            ...
            public override void InvokeOnAuthorityLostCallbacks(Dictionary<Unity.Entities.Entity, InjectableStore> entityToInjectableStore)
            {
                ...
                Profiler.BeginSample("PlayerCreator");
                var entities = AuthorityLostComponentGroup.GetEntityArray();
                var changeOpsLists = AuthorityLostComponentGroup.GetComponentDataArray<AuthorityChanges<Improbable.PlayerLifecycle.PlayerCreator.Component>>();
            ...
            private bool IsFirstAuthChange(Authority authToMatch, AuthorityChanges<Improbable.PlayerLifecycle.PlayerCreator.Component> changeOps)
            {
