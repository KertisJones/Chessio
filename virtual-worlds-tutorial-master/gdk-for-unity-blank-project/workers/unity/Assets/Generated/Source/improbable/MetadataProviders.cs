...
{
    private static readonly Dictionary<uint, List<Improbable.Metadata.Update>> Storage = new Dictionary<uint, List<Improbable.Metadata.Update>>();
    ...
    public static uint Allocate(global::Unity.Entities.World world)
    {
        ...
        Storage.Add(handle, default(List<Improbable.Metadata.Update>));
        WorldMapping.Add(handle, world);

        return handle;
    }

    public static List<Improbable.Metadata.Update> Get(uint handle)
    {
    ...
    public static void Set(uint handle, List<Improbable.Metadata.Update> value)
    {
