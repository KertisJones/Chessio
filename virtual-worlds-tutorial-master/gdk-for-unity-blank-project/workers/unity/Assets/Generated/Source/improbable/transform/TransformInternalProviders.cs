...
{
    private static readonly Dictionary<uint, List<Improbable.Transform.TransformInternal.Update>> Storage = new Dictionary<uint, List<Improbable.Transform.TransformInternal.Update>>();
    ...
    public static uint Allocate(global::Unity.Entities.World world)
    {
        ...
        Storage.Add(handle, default(List<Improbable.Transform.TransformInternal.Update>));
        WorldMapping.Add(handle, world);

        return handle;
    }

    public static List<Improbable.Transform.TransformInternal.Update> Get(uint handle)
    {
    ...
    public static void Set(uint handle, List<Improbable.Transform.TransformInternal.Update> value)
    {
