...
{
    private static readonly Dictionary<uint, List<Improbable.Position.Update>> Storage = new Dictionary<uint, List<Improbable.Position.Update>>();
    ...
    public static uint Allocate(global::Unity.Entities.World world)
    {
        ...
        Storage.Add(handle, default(List<Improbable.Position.Update>));
        WorldMapping.Add(handle, world);

        return handle;
    }

    public static List<Improbable.Position.Update> Get(uint handle)
    {
    ...
    public static void Set(uint handle, List<Improbable.Position.Update> value)
    {
